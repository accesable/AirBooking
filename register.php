<?php
    ...
    && isset($_POST['user']) && isset($_POST['pass']) && isset($_POST['pass-confirm']))
    {
        ...
        if (empty($first_name)) {
            ...
            $result = validate_register($user,$pass,$email,$last_name,$first_name,$phone);
            if($result['code']==0){
...
<head>
    ...
    <style>
        body {
			background-image: url('images/maybaydong.jpg');
			background-size: cover;
		}

        .col-xl-5.col-lg-6.col-md-8.border.my-5.p-4.rounded.mx-3 {
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 border my-5 p-4 rounded mx-3">
                ...
                <form method="post" action="" novalidate>
                    ...
                    <div class="form-group">
                        <label for="user">Telephone number</label>
                        <input value="<?= $user?>" name="phone" required class="form-control" type="text" placeholder="Phone Number" id="phone">
                    ...
                    <div class="form-group">
                        <?php
                            if (!empty($error)) {
                                ...
                                echo "<div class='success alert-danger'>$error</div>";
                            }
                        ?>
